		...
		<div class="container-card">
			...
			<form action="/action_page.php">
				<div class="inner-card">
					...
					<button @click.prevent="goToResult" class="submitbtn">Continue to recommended price</button>
				</div>
			</form>
		</div>
	</div>
				...
				getPredictedPrice(userSelectionPayload)
					...
					.then(async (data) => {
						if (!data.error) {
							...
							await savePredictions(this.$store.state.user, userSelectionPayload, responseBody.result);
